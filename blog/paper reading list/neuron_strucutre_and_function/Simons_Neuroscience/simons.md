# Simons Foundation Global Brain Projects

## Table of Contents

1. [Analyzing a complex motor act at the mesoscopic scale](#analyzing-a-complex-motor-act-at-the-mesoscopic-scale)
2. [Attentional modulation of neuronal variability constrains circuit models](#attentional-modulation-of-neuronal-variability-constrains-circuit-models)
3. [Catching fireflies: Dynamic neural computations for foraging](#catching-fireflies-dynamic-neural-computations-for-foraging)
4. [Circuit mechanisms of social cognitive computations](#circuit-mechanisms-of-social-cognitive-computations)
5. [Computational principles of mechanisms underlying cognitive functions](#computational-principles-of-mechanisms-underlying-cognitive-functions)
6. [Cortical mechanisms of multistable perception](#cortical-mechanisms-of-multistable-perception)
7. [Corticocortical signaling between populations of neurons](#corticocortical-signaling-between-populations-of-neurons)
8. [Decoding internal state to predict behavior](#decoding-internal-state-to-predict-behavior)
9. [Dense Mapping of Dynamics onto Structure in the C. elegans Brain](#dense-mapping-of-dynamics-onto-structure-in-the-c-elegans-brain)
10. [Dynamics of neural circuits, representation of information, and behavior](#dynamics-of-neural-circuits-representation-of-information-and-behavior)
11. [Global brain states and local cortical processing](#global-brain-states-and-local-cortical-processing)
12. [Hidden states and functional subdivisions of fronto-parietal network](#hidden-states-and-functional-subdivisions-of-fronto-parietal-network)
13. [Higher-Level Olfactory Processing](#higher-level-olfactory-processing)
14. [How the basal ganglia forces cortex to do what it wants](#how-the-basal-ganglia-forces-cortex-to-do-what-it-wants)
15. [Interaction of sensory signals and internal dynamics during decision-making](#interaction-of-sensory-signals-and-internal-dynamics-during-decision-making)
16. [Large-scale cortical and thalamic networks that guide oculomotor decisions](#large-scale-cortical-and-thalamic-networks-that-guide-oculomotor-decisions)
17. [Large-Scale Data and Computational Framework for Circuit Investigation](#large-scale-data-and-computational-framework-for-circuit-investigation)
18. [Mechanisms of Context-Dependent Neural Integration and Short-Term Memory](#mechanisms-of-context-dependent-neural-integration-and-short-term-memory)
19. [Modulating the dynamics of human-level neuronal object representations](#modulating-the-dynamics-of-human-level-neuronal-object-representations)
20. [Network mechanisms for correcting error in high-order cortical regions](#network-mechanisms-for-correcting-error-in-high-order-cortical-regions)
21. [Network properties and plasticity in high- and low-gain cortical states](#network-properties-and-plasticity-in-high--and-low-gain-cortical-states)
22. [Neural Circuit Dynamics During Cognition](#neural-circuit-dynamics-during-cognition)
23. [Neural coding and dynamics for short-term memory](#neural-coding-and-dynamics-for-short-term-memory)
24. [Neural computation of innate defensive behavioral decisions](#neural-computation-of-innate-defensive-behavioral-decisions)
25. [Neural dynamics for a cognitive map in the macaque brain](#neural-dynamics-for-a-cognitive-map-in-the-macaque-brain)
26. [Neural encoding and decoding of policy uncertainty in the frontal cortex](#neural-encoding-and-decoding-of-policy-uncertainty-in-the-frontal-cortex)
27. [Population dynamics across pairs of cortical areas in learning and behavior](#population-dynamics-across-pairs-of-cortical-areas-in-learning-and-behavior)
28. [Probing recurrent dynamics in prefrontal cortex](#probing-recurrent-dynamics-in-prefrontal-cortex)
29. [Relating dynamic cognitive variables to neural population activity](#relating-dynamic-cognitive-variables-to-neural-population-activity)
30. [Searching for universality in the state space of neural networks](#searching-for-universality-in-the-state-space-of-neural-networks)
31. [Single-trial visual familiarity memory acquisition](#single-trial-visual-familiarity-memory-acquisition)
32. [Spatiotemporal structure of neural population dynamics in the motor system](#spatiotemporal-structure-of-neural-population-dynamics-in-the-motor-system)
33. [The latent dynamical structure of mental activity](#the-latent-dynamical-structure-of-mental-activity)
34. [The neural basis of Bayesian sensorimotor integration](#the-neural-basis-of-bayesian-sensorimotor-integration)
35. [The neural substrates of memories and decisions](#the-neural-substrates-of-memories-and-decisions)
36. [Towards a theory of multi-neuronal dimensionality, dynamics and measurement](#towards-a-theory-of-multi-neuronal-dimensionality-dynamics-and-measurement)
37. [Toward Computational Neuroscience of Global Brains](#toward-computational-neuroscience-of-global-brains)
38. [Understanding neural computations across the global brain](#understanding-neural-computations-across-the-global-brain)
39. [Understanding visual object coding in the macaque brain](#understanding-visual-object-coding-in-the-macaque-brain)
40. [Whole brain calcium imaging in freely behaving nematodes](#whole-brain-calcium-imaging-in-freely-behaving-nematodes)
41. [Brainwide dynamics of a social interaction](#brainwide-dynamics-of-a-social-interaction)
42. [Communication among sensorimotor cortices: Where state space meets biology](#communication-among-sensorimotor-cortices-where-state-space-meets-biology)
43. [Communication between neural populations: circuits, coding, and behavior](#communication-between-neural-populations-circuits-coding-and-behavior)
44. [Computation timescales as an organizing principle of large-scale cortical dynamics during decision-making](#computation-timescales-as-an-organizing-principle-of-large-scale-cortical-dynamics-during-decision-making)
45. [Computation-through-dynamics as a framework to link brain and behavior](#computation-through-dynamics-as-a-framework-to-link-brain-and-behavior)
46. [Discovering repeating neural motifs representing sequenced behavior](#discovering-repeating-neural-motifs-representing-sequenced-behavior)
47. [Dissecting navigation and the general logic of episodic state computation](#dissecting-navigation-and-the-general-logic-of-episodic-state-computation)
48. [Dissection of inter-area interactions of motor circuits](#dissection-of-inter-area-interactions-of-motor-circuits)
49. [Dynamical computation in populations — analysis and theory](#dynamical-computation-in-populations--analysis-and-theory)
50. [How does the brain predict the future? Large-scale neural calcium imaging, two-photon optogenetic and deep neural network studies of future prediction across 11 neocortical areas in behaving mice](#how-does-the-brain-predict-the-future-large-scale-neural-calcium-imaging-two-photon-optogenetic-and-deep-neural-network-studies-of-future-prediction-across-11-neocortical-areas-in-behaving-mice)
51. [Integrative approaches to understanding whole-brain computation](#integrative-approaches-to-understanding-whole-brain-computation)
52. [Inter-regional interactions underlying the decision to act, at spiking resolution](#inter-regional-interactions-underlying-the-decision-to-act-at-spiking-resolution)
53. [International brain lab](#international-brain-lab)
54. [Investigating symbol-like reasoning in the brain: Neural mechanisms of compositional action planning](#investigating-symbol-like-reasoning-in-the-brain-neural-mechanisms-of-compositional-action-planning)
55. [Leveraging dynamical smoothness to predict motor cortex population activity](#leveraging-dynamical-smoothness-to-predict-motor-cortex-population-activity)
56. [Multi-regional neuronal dynamics of memory-guided flexible behavior](#multi-regional-neuronal-dynamics-of-memory-guided-flexible-behavior)
57. [Neural circuit dynamics underlying sequence and variability](#neural-circuit-dynamics-underlying-sequence-and-variability)
58. [Neural computations for visual form processing and form-based cognition](#neural-computations-for-visual-form-processing-and-form-based-cognition)
59. [Neural dynamics of a multi-timescale social behavior](#neural-dynamics-of-a-multi-timescale-social-behavior)
60. [Neural mechanisms of context dependent cognitive behavior](#neural-mechanisms-of-context-dependent-cognitive-behavior)
61. [Neural substrates of behavior and action selection in model organisms](#neural-substrates-of-behavior-and-action-selection-in-model-organisms)
62. [Outer brain and inner brain: computational principles and interactions](#outer-brain-and-inner-brain-computational-principles-and-interactions)
63. [Plasticity of global brain dynamics: tunable neural integration](#plasticity-of-global-brain-dynamics-tunable-neural-integration)
64. [Remapping across time, space and region](#remapping-across-time-space-and-region)
65. [Single-neuron-resolution population dynamics in human Broca's area and motor cortex when preparing and producing speech](#single-neuron-resolution-population-dynamics-in-human-brocas-area-and-motor-cortex-when-preparing-and-producing-speech)
66. [The representation of internal state in the fly brain](#the-representation-of-internal-state-in-the-fly-brain)
67. [Theory of distributed persistent activity in large-scale brain circuits](#theory-of-distributed-persistent-activity-in-large-scale-brain-circuits)
68. [Theory-driven approaches to identify minimal circuits for susceptibility and resilience](#theory-driven-approaches-to-identify-minimal-circuits-for-susceptibility-and-resilience)
69. [Using brain-machine interfaces to identify and manipulate computational principles of learning](#using-brain-machine-interfaces-to-identify-and-manipulate-computational-principles-of-learning)
...
**Description:**
*No detailed description available from the webpage.*
...
### Theory-driven approaches to identify minimal circuits for susceptibility and resilience
